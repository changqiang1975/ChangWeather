...
public class AutoUpdateService extends Service
{
    ...
    private void updateWeather()
    {
        ...
        if(weatherString != null)
        {
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=35be2fb9e7f24c6098f28fa11a8a7674";
    ...
    private void updateBingPic()
    {
        ...
        HttpUtility.sendOkHttpRequest(requestBingPic, new Callback()
        {
            @Override
            public void onFailure(Call call, IOException e)
            {
